        ...
        <div class="row">
            <div class="col-sm-6 text-right fsz-16 pt-15 xs-text">
                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                    ut laoreet dolore magna aliquam enim ad minim veniam, quis nostrud exerci tation.</p>
            </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 text-center">
                <div class="feature-wrap">
                    ...
                    <h3 class="title-1 ptb-15"> <span class="light-font">fresh from </span> <strong> havana farm</strong> </h3>
            ...
            <div class="col-md-3 col-sm-6 text-center">
                <div class="feature-wrap">
                    ...
                    <h3 class="title-1 ptb-15"> <span class="light-font"> 100%</span> <strong> havana goods</strong> </h3>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy. </p>
                    <a href="#" class="sm-bnt-wht">Read More</a>
                </div>
            </div>
    ...
    <div class="container rel-div">
        <div class="title-wrap pt-15">
            ...
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                ...
                magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud ullamcorper . </p>
        </div>
        ...
        <div class="row sec-space-top">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="organic-prod">
                            ...
                            <i class="clr-txt font-2"> 52 items </i>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="organic-prod">
                    ...
                    <div class="col-sm-4">
                        <div class="organic-prod">
                            ...
                            <i class="clr-txt font-2"> 23 items </i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-sm-12">
                <div class="organic-prod-info">
                    ...
                    <p class="fsz-16">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="organic-prod">
                            ...
                            <i class="clr-txt font-2"> 26 items </i>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="organic-prod">
